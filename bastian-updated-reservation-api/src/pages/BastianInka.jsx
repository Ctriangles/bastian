...
// import bg from "../assets/Images/inka-banner.png";
import bg from "../assets/Images/inka-banner-img.jpg";
...
import pdf1 from "../assets/Images/food-menu.pdf";
import pdf2 from "../assets/Images/Vegan-Menu.pdf";
import pdf3 from "../assets/Images/dessert-tea-coffee.pdf";
import inkaGallery1 from "../assets/Images/inka-gallery1.png";
import inkaGallery2 from "../assets/Images/inka-gallery2.png";
import inkaGallery3 from "../assets/Images/inka-gallery3.png";
import inkaGallery4 from "../assets/Images/inka-gallery4.png";
import inkaGallery5 from "../assets/Images/inka-gallery5.png";
import inkaGallery6 from "../assets/Images/inka-gallery6.png";
import inkaGallery7 from "../assets/Images/inka-gallery7.png";
import inkaGallery8 from "../assets/Images/inka-gallery8.png";
...
import discoverevent from "../assets/Images/discover-img01.png";
import discoverevent2 from "../assets/Images/discover-img02.png";
import discoverevent3 from "../assets/Images/discover-img03.png";
...
export default function BastianInkaPage() {
  const HeroImgText = {
    heading1: "by Bastian",
    heading2: `A bold, chef-driven concept, Inka reimagines Peruvian-Asian cuisine with global flair, table-side theatre, and dishes that speak for themselves. `,
    changeStyle: true,
  };
  ...
  const galleryData = {
    ...
    food: [inkaGallery5, inkaGallery6, inkaGallery7, inkaGallery8, inkaGallery2],
    events: [inkaEvent1, inkaEvent2, inkaEvent3, inkaEvent1, inkaEvent2, inkaEvent3],
  };
  ...
  const contentData = {
    1: {
      ...
      desc: "Perfect pours and sweet escapes.",
      pdf: pdf3,
      bg: discoverevent,
    },
    2: {
      title: "Food",
      desc: "Flavours crafted for every craving",
      pdf: pdf1,
      bg: discoverevent2,
    },
    3: {
      title: "Vegan",
      desc: "Wholesome bites, consciously created",
      pdf: pdf2,
      bg: discoverevent3,
    },
  };
  ...
  return (
    <div className="w-full h-auto min-h-screen page-height inka-page">
      ...
      {/* Hero Section */}
      <div className="attop-banner bastianinka-banner">
        <HeroSection
          bg={bg}
          bg2={bg}
        ...
        />
        <div
          className="flex justify-center mt-6 btn-box-wrapper"
          data-aos="fade-up"
        >
          <button
            className="btn"
            ...
            <div className="relative z-10 flex flex-row mob-col">
              {[1, 2, 3].map((col) => (
                ...
                >
                  {activeCol === col && (
                    <>
                      <h3 className="text-2xl md:text-[34px] text-[#f2ca99] font-semibold mb-3">
                        {contentData[col].title}
                      </h3>
                      <p className="text-white text-[16px] md:text-[18px] mb-[23px] leading-[1]">
      ...
      {selectedEvent && (
        ...
        >
          <div
            className="bg-[#151515] pop-up-container text-white rounded-lg shadow-lg max-w-[1092px] p-6 md:p-[50px] lg:p-[92px] w-full flex flex-col gap-[30px] md:gap-[48px] md:flex-row overflow-hidden relative md:max-h-[70vh] overflow-y-auto"
