...
class form_model extends CI_Model
{
    ...
    public function AllEnquiry()
    {
        ...
        $this->db->select('tbl_forms_data.*, eatapp_restaurants.name as restaurant_name');
        $this->db->from("tbl_forms_data");
        $this->db->join('eatapp_restaurants', 'tbl_forms_data.restaurant_id = eatapp_restaurants.eatapp_id', 'left');
