...
|--------------------------------------------------------------------------
| Just comment/uncomment the environment block you want to use
| No complex if-else logic, keep it simple
*/

// LOCAL DEVELOPMENT ENVIRONMENT (Comment this block for other environments)
