                ...
                <table id="datatable" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th>Category</th>
                            <th>Last Edit</th>
                            <?php if(array_search('blog_edit',$this->role_list) !== false || array_search('blog_delete',$this->role_list) !== false) { ?>
                            <th>Action</th>
                            <?php } ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(array_search('blog_edit',$this->role_list) !== false) { ?>
                                <a class="btn btn-outline-success waves-effect waves-light" href="<?=site_url('backend/EditBlog/'.$AllData->id.'/')?>"><i class="uil-edit"></i></a>
                                <?php } if(array_search('blog_delete',$this->role_list) !== false) { ?>
