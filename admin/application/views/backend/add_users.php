        ...
        <div class="col-3">
            ...
            <div class="card-body">
               ...
               <div class="mb-3 row">
                  ...
                  <div class="col-md-12">
                     <input id="imgpath" type="hidden" name="user_img" value="<?php if(isset($editdata)){echo $editdata->user_img ? $editdata->user_img : '';}?>" style="width:60%"/>
                     <button id="imgbutton" type="button" class="form-control">Browse Image</button>
                     <span id="imgsrc" > <?php if(isset($editdata->user_img) && $editdata->user_img != "") {?> <img src="<?php echo site_url(); ?><?=$editdata->user_img?>" style="width:100% !important"><?php }  ?> </span>
                  </div>
               </div>
                <div class="mt-4">
