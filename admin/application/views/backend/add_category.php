      ...
      <div class="col-9">
         <div class="card">
            <div class="card-body">
               ...
               <div class="mb-3 row">
                  <label for="cat_title" class="col-md-12 col-form-label">Title</label>
                  <div class="col-md-12">
                     <input type="hidden" name="id" value="<?php if(isset($editdata)){echo $editdata->id ? $editdata->id : '' ;}?>" >
                     <input type="text" name="cat_title" id="cat_title" value="<?php if(isset($editdata)){echo $editdata->cat_title?$editdata->cat_title:'';}?>" class="form-control" onblur="myFunction()">
                  </div>
               </div>
               <div class="mb-3 row">
                  <label for="cat_slug" class="col-md-12 col-form-label">URL</label>
                  <div class="col-md-12">
                     <input type="text" name="cat_slug" id="cat_slug" value="<?php if(isset($editdata)){echo $editdata->cat_slug?$editdata->cat_slug:'';}?>" class="form-control">
                  </div>
               </div>
               <div class="mb-3 row">
                  <label for="cat_disc" class="col-md-12 col-form-label">Content</label>
                  <div class="col-md-12">
                     <textarea cols="40" id="cat_disc" name="cat_disc" rows="12" style="width:100px;"><?php if(isset($editdata)){echo $editdata->cat_disc ? $editdata->cat_disc : '';}?></textarea>
                     <script type="text/javascript">
                        CKEDITOR.replace( 'cat_disc',
                        {
                            uiColor: '#f4f6f9',
                                            ...
                                            <div class="card-body metadisplays">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <small><?=str_replace(['https://', 'http://'], '', site_url());?> > <span id="pageslug"><?php if(isset($editdata)){echo $editdata->cat_slug?$editdata->cat_slug:'';}?></span></small>
                                                    </div>
                                                    <div class="col-md-12">
      ...
      <div class="col-3">
         <div class="card">
            <div class="card-body">
               ...
               <hr>
               <div class="mb-3 row">
                  <label for="parent_cat" class="col-md-12 col-form-label">Parent Category</label>
                  <div class="col-md-12">
                     <select class="form-select select2" id="parent_cat" name="parent_cat">
                        <option value="">Select Category</option>
                        <?php foreach($pages as $page) { ?>
                            <option value="<?=$page->id?>" <?php if(isset($editdata)){if($page->id == $editdata->parent_cat){echo 'selected';}}?>><?=$page->cat_title?></option>
                        <?php } ?>
                     </select>
                  </div>
               </div>
               <div class="mb-3 row">
                  ...
                  <div class="col-md-12">
                     <input id="imgpath" type="hidden" name="cat_image" value="<?php if(isset($editdata)){echo $editdata->cat_image ? $editdata->cat_image : '';}?>" style="width:60%"/>
                     <button id="imgbutton" type="button" class="form-control">Browse Image</button>
                     <span id="imgsrc" > <?php if(isset($editdata->cat_image) && $editdata->cat_image != "") {?> <img src="<?php echo site_url(); ?><?=$editdata->cat_image?>" style="width:100% !important"><?php }  ?> </span>
                  </div>
               </div>
               <div class="mt-4">
...
<script>
   function myFunction() {
       var x = document.getElementById("cat_title"); 
       var y = document.getElementById("cat_slug"); 
