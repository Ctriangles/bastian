      ...
      <div class="col-9">
         <div class="card">
            <div class="card-body">
               ...
               <div class="mb-3 row">
                  <label for="post_title" class="col-md-12 col-form-label">Title</label>
                  <div class="col-md-12">
               ...
               <div class="mb-3 row">
                  <label for="post_slug" class="col-md-12 col-form-label">URL</label>
                  <div class="col-md-12">
               ...
               <div class="mb-3 row">
                  <label for="post_content" class="col-md-12 col-form-label">Content</label>
                  <div class="col-md-12">
      ...
      <div class="col-3">
         <div class="card">
            <div class="card-body">
               ...
               <hr>
               <div class="mb-3 row">
                  <label for="post_cat" class="col-md-12 col-form-label">Category</label>
                  <div class="col-md-12">
                     <select class="form-select select2" id="post_cat" name="post_cat">
                        <option value="">Select Category</option>
                        <?php foreach($pages as $page) { ?>
                            <option value="<?=$page->id?>" <?php if(isset($editdata)){if($page->id == $editdata->post_cat){echo 'selected';}}?>><?=$page->cat_title?></option>
                        <?php } ?>
                     </select>
                  </div>
               </div>
