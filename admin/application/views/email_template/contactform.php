...
**/
  ...
  **/
        ...
        body[override] table.st-Header td.st-Header-background div.st-Header-area {
          background-image: url('<?=site_url(@$this->site_logo)?>') !important;
        }
        /** Modifier: white */
  ...
  **/
   ...
   **/
    ...
    width: 100%;
    background-repeat: no-repeat !important;
    background-size: 110px 21px !important;
}
table.st-Header td.st-Header-logo div.st-Header-area{
  width:100% !important;
}
                    ...
                    <table class="st-Header st-Header--simplified st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="st-Header-logo" align="left" height="21" width="" style="border: 0; margin: 0; padding: 0;">
                            <div class="st-Header-area st-Target st-Target--mobile">
                              <a style="border: 0; margin: 0; padding: 0; text-decoration: none;" href="<?=site_url()?>">
                                <img alt="Logo" border="0" class="st-Header-source"width="200" style="border: 0; margin: 0; padding: 0; color: #0f6fec; display: block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 12px; font-weight: normal;" src="<?=site_url(@$this->site_logo)?>">
                              </a>
                            </div>
                          </td>
                    ...
                    <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                          <p>You have received new Reservation, please see details below: </p>
                          <ul>
                            <li><b>Restaurant Name: </b> 
                            <?=($message->restaurant_id == '43383004')?'Bastian At The Top':''?>
                            <?=($message->restaurant_id == '98725763')?'Bastian Bandra':''?>
                            <?=($message->restaurant_id == '51191537')?'Bastian Chinois':''?>
                            <?=($message->restaurant_id == '10598428')?'Bastian Empire':''?>
                            <?=($message->restaurant_id == '92788130')?'Bastian Garden City':''?>
                          </li>
                            <li><b>Booking Date: </b> <?=$message->booking_date?></li>
                            <!--<li><b>Booking Time: </b> <? //=$message->booking_time?></li>-->
                            <li><b>Full Name: </b> <?=$message->full_name?></li>
                            <li><b>Email: </b> <?=$message->email_id?></li>
                            <li><b>Phone Number: </b> <?=$message->contact_number?></li>
                            <li><b>Age: </b> <?=$message->age?></li>
                            <li><b>Pax: </b> <?=$message->pax?></li>
                            <li><b>Pin Code: </b> <?=$message->pin_code?></li>
                          </ul>
                          </td>
                          <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                            <div class="st-Spacer st-Spacer--filler"> </div>
